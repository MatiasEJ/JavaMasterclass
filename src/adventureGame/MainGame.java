...
public class MainGame {
	...
	public static void main(String[] args) {
		...
		location.put(0, new Location(0, "You are sitting in front of a toilet",tmpExits));
		...
		tmpExits = new HashMap<>();
		tmpExits.put("N", 5);
		location.put(2, new Location(2, "You are sitting in front of a computer2",tmpExits));

		tmpExits = new HashMap<>();
		tmpExits.put("W", 1);
		tmpExits.put("Q", 0);
		location.put(3, new Location(3, "You are sitting in front of a computer3",tmpExits));

		tmpExits = new HashMap<>();
		tmpExits.put("N", 1);
		tmpExits.put("W", 2);
		location.put(4, new Location(4, "You are sitting in front of a computer4",tmpExits));

		tmpExits.put("S", 1);
		tmpExits.put("W", 2);
		location.put(5, new Location(5, "You are sitting in front of a computer5",tmpExits));
